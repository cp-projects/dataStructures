...
void insert_at_head(doubly_t* list, const float val){
...
float remove_at_head(doubly_t* list){
...
void insert_at_tail(doubly_t* list, const float val){
...
float remove_at_tail(doubly_t* list){
...
void insert_after_index(doubly_t* list, float val, int index){
    ...
    doubly_flt_t* old_index = itr_forward(list, 0, index, 0, 0, 1);
...
void insert_after_val(doubly_t* list, float newVal, float testVal){
    ...
    doubly_flt_t* old_val = itr_forward(list, testVal, 0, 0, 1, 0);
