...
size_t ret_len_sin_dbl(singly_t* list){
        return list->len;
}
...
void push_sin_dbl(singly_t* list, const double val){
...
void enqueue_sin_dbl(singly_t* list, const double val){
